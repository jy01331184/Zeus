...
import com.zeus.core.size.ZeusMethodStruct6_0;
...
public class ZeusCompatFix6_0 implements IZeusCompatFix {
    ...
    private IZeusMethodStruct methodStruct = new ZeusMethodStruct6_0();

    public ZeusCompatFix6_0() {
        try {
